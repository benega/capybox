...
5. Read Tasks at `specs/tasks/prd-[feature-slug]/.specs/tasks.md` and verify completion status of each task.
...
- If Playwright MCP is unavailable, report the error and suggest running E2E tests manually with `npm run test:e2e`.
